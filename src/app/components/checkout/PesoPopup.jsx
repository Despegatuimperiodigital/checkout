...
`.trim();
    ...
    const whatsappUrl = `https://wa.me/56991711474?text=${encodedMessage}`;
  ...
  return (
    ...
    >
      <div className="bg-white p-8 rounded-lg shadow-xl max-w-md text-center relative">
        ...
        <button onClick={handleWhatsAppClick} className="bg-[#c69393] text-white px-4 py-2 rounded hover:bg-[#c69393] transition-colors mb-2 w-full">
